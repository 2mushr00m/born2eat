    ...
    return (
        ...
        <div id="map-wrap">
            <Map
                ...
                <CustomOverlayMap position={{ lat: 33.55735, lng: 126.795941 }}>
                    어어엉?
                </CustomOverlayMap>
            ...
            <div style={{position: 'absolute', top: '10px', left: '10px',overflow: 'hidden', zIndex:1}} onClick={()=>alert('ㅇㅇ')}>커스텀 버튼</div>
        </div>
        <p>
            <button
                onClick={() =>
